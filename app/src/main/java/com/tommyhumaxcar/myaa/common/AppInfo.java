package com.tommyhumaxcar.myaa.common;
...
public class AppInfo {
    public static String    APP                 =   "MY AA - ";
    ...
    public static String    APP_TITLE           =   "My AA";
    public static String    APP_TEXT            =   "This is text from My AA";
    public static int       APP_ICON            =   R.drawable.my_aa;
    public static String    ACTION_AA_SEND_NOTI    =     "ACTION_AA_SEND_NOTI";
